...
function renderNav(activePage) {
  ...
  var pages = [
    ...
    { href: base + 'pages/properties.html', label: 'Properties' },
    { href: base + 'pages/account.html',    label: 'My Account' },
    { href: base + 'pages/business.html',   label: 'For Business' }
  ];
  ...
  return '<nav class="nav" id="main-nav">' +
    '<div class="nav-inner">' +
      '<a href="' + base + 'index.html" class="nav-logo">Glo<span>spot</span></a>' +
      ...
      '<div class="nav-right">' +
        ...
        '</div>' +
        '<a href="' + base + 'pages/account.html" class="btn btn-navy btn-sm">Sign in</a>' +
    ...
    '<div class="footer-inner">' +
      '<div class="footer-grid">' +
        ...
        '<div class="footer-col"><h4>Explore</h4>' +
          ...
          '<a href="' + base + 'pages/properties.html">Hotels</a>' +
          '<a href="' + base + 'pages/properties.html">Apartments</a>' +
          '<a href="' + base + 'pages/properties.html">Deals</a>' +
        '</div>' +
        '<div class="footer-col"><h4>Account</h4>' +
          '<a href="' + base + 'pages/account.html">Sign In</a>' +
          '<a href="' + base + 'pages/account.html">My Bookings</a>' +
          '<a href="' + base + 'pages/account.html">Favourites</a>' +
          '<a href="' + base + 'pages/account.html">Reviews</a>' +
        '</div>' +
        '<div class="footer-col"><h4>Company</h4>' +
          '<a href="' + base + 'pages/business.html">For Business</a>' +
          '<a href="' + base + 'pages/terms.html">Terms &amp; Privacy</a>' +
          '<a href="' + base + 'pages/terms.html">Cookie Policy</a>' +
          '<a href="#">Contact Us</a>' +
        '</div>' +
      '</div>' +
      '<div class="footer-bottom">' +
        ...
        '<div class="footer-legal">' +
          '<a href="' + base + 'pages/terms.html">Privacy Policy</a>' +
